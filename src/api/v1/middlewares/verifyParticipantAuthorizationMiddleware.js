...
const verifyParticipantAuthorization = asyncHandler(async (req, res, next) => {
  ...
  console.log("\n------ End of verifyParticipantAuthorization ------\n");
  next();
});

module.exports = verifyParticipantAuthorization;
